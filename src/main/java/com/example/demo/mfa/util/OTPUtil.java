package com.example.demo.mfa.util;
...
public class OTPUtil {
    ...
    public static HashMap<String, Object> generate(String productName, String username) {
        ...
        String encodedKey = new String(bEncodeKey); // 생성된 Key (해당 키로 OTP 확인)
    ...
    public static boolean checkCode(String otpNumber, String secretKey) {
        ...
        long wave = new Date().getTime() / 30000; // OTP 의 주기 (초)
    ...
    public static String getQRBarcodeURL(String productName, String userName, String secret) {
        // QR 코드 주소 생성
        String codeURL = "http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=otpauth://tptp/%s(%s)%%3Fsecret%%3D%s&chld=H|0";
